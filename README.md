...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Schema/packages/locationposts-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Schema/packages/locationposts-wp).
